...
class ReportController extends Controller
{
    ...
    public function userOrderUpdate(Request $request, $id)
    {
        ...
        if($request->courier == 'Steadfast'){
            ...
            $apiKey = '3od1wjgu4fxhm5tirbgz99hjsihhelsp';
            $secretKey = 'esay8xac13c6zhpybcqwfjhr';
    ...
    public function userDropshippingOrderTransfer(Request $request, $id)
    {
        ...
        if ($action == 'transfer') {
            ...
            $appKey = 'KQIRAMR1ZARZ6P39';
            $appSecret = 'HsPsPnJSG9cBBjvWIK7bV96aonqGYmsA';
            $userName = 'moudud-ahmed-shojib_halaliyancom';
